...
def main_top(direc):
   ...
   #Mapeo de Las etiquetas
    ...
    current_dir = os.path.dirname(current_dir)
    archivoDispositivos = os.path.join('..','..')
    print(current_dir)
    RUTA_ARCHIVO_TOPOLOGIA = current_dir  + r"/app_2024/src/public/js/topologia_fija.js"
    RUTA_ARCHIVO_DIFERENCIAS_TOPOLOGIA =current_dir + r"/app_2024/src/public/js/topologia_diferencias.js"
    RUTA_ARCHIVO_TOPOLOGIA_CACHE = current_dir + r"/app_2024/src/public/js/topologia_cache.json"
    ...
    if TOPOLOGIA_CACHE:
        ...
        if cambio_topologia:
                with open(current_dir+'/app_2024/src/public/js/changes_flag.json', 'w') as f:
